...
def create_cloudinary_photo(user_id, photo, photo_type):
    user = User.query.get(user_id)
    print(f'PHOTO: {photo}')
    public_id = f"{user.username}{photo_type}"
    ...
    try: 
        ...
        cloudinary.uploader.upload(photo, public_id=public_id)
        return 'success'
    except:
        return 'failed'
...
def get_cloudinary_slideshow_photos(user_id):
    ...
    print(f'USER {user}')
    print(f'USER ID: {user.username}_slideshow_photo_1')
    slideshow_list = []
    slideshow_list.append(f"https://res.cloudinary.com/{cloud_name}/image/upload/{user.username}_slideshow_photo_1.jpg")
    slideshow_list.append(f"https://res.cloudinary.com/{cloud_name}/image/upload/{user.username}_slideshow_photo_2.jpg")
    slideshow_list.append(f"https://res.cloudinary.com/{cloud_name}/image/upload/{user.username}_slideshow_photo_3.jpg")
...
def get_cloudinary_profile_photo(user_id):
    user = User.query.get(user_id)
    public_id = user.username + "_profile_photo"
    try:
